# Arduino IDE Setup & Programming Guide

The Arduino Integrated Development Environment (IDE) is a text-based open-source software used to write, compile, and upload syntax-based C/C++ code to Arduino-compatible microcontrollers.
